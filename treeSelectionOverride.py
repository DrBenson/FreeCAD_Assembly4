...
class treeSelectionOverrideCmd(QtGui.QDialog):
    ...
    def GetResources(self):
        return {"MenuText": _atr("Asm4_treeSelectionOverride", "Enable/Disable 3D View selection mode"),
                "ToolTip": _atr("Asm4_treeSelectionOverride", "Enable/Disable 3D View selection mode\n\n" +
...
def Enable():
    ...
    FCC.PrintMessage(_atr("Asm4_treeSelectionOverride",
                     "3D view link selection mode is now ENABLED\n"))
...
def Disable():
    ...
    if print_disable:
        FCC.PrintMessage(_atr("Asm4_treeSelectionOverride",
                         "3D view link selection mode is now DISABLED\n"))
