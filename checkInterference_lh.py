...
class checkInterference:
    ...
    def check_interferences(self, ilim=0, jlim=0):
        ...
        intersections_folder = self.modelDoc.addObject(
        ...
        Intersections = self.modelDoc.addObject(
    ...
    def make_intersection(self, doc, obj1, obj2, count):
        ...
        obj.Label = "Common {} - {} - {}".format(
            str(count), obj1.Label, obj2.Label)
    ...
    def remove_empty_common(self, obj):
        try:
            if obj.Shape:
                try:
                    print(_atr("Asm4_checkInterference",
                          "{} | Collision detected").format(obj.Label))
                    if obj.Shape.Volume > 0.0:
                        return False
                    else:
                        print(_atr("Asm4_checkInterference",
                              "{} | Touching faces (REMOVING)").format(obj.Label))
    ...
    def remove_interference_folder(self):
        ...
        try:
            ...
            self.modelDoc.removeObject(existing_folder.Name)
            self.modelDoc.recompute()
        except:
            pass
