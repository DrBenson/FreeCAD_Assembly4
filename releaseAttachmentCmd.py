...
class releaseAttachment:
    ...
    def GetResources(self):
        return {"MenuText": _atr("Asm4_releaseAttachment", "Release from Attachment"),
                "ToolTip": _atr("Asm4_releaseAttachment", "Release an object from all attachments to any geometry"),
    ...
    def Activated(self):
        ...
        confirmText = _atr("Asm4_releaseAttachment", 'This command will release all attachments on ')+Asm4.labelName(selectedObj) \
            + _atr("Asm4_releaseAttachment",
