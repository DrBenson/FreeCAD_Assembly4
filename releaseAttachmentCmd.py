...
class releaseAttachment:
    ...
    def GetResources(self):
        return {"MenuText": App.Qt.translate("Assembly", "Release from Attachment"),
                "ToolTip": App.Qt.translate("Assembly", "Release an object from all attachments to any geometry"),
    ...
    def Activated(self):
        ...
        confirmText = App.Qt.translate("Assembly", 'This command will release all attachments on ')+Asm4.labelName(selectedObj) \
            + App.Qt.translate("Assembly",
