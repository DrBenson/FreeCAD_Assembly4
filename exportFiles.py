...
class listLinkedFiles():
    ...
    def GetResources(self):
        menutext = _atr("Asm4_Export", "Tree of Linked Files")
        tooltip = _atr("Asm4_Export", "<p>Show the hierarchical tree structure of parts in the selected container. "
    ...
    def Activated(self):
        ...
        if len(Gui.Selection.getSelection()) == 1:
            ...
            FCC.PrintWarning(_atr(
                "Asm4_Export", "Oups, you shouldn't see this message, something went wrong"))
    ...
    def copyToClip(self):
        ...
        self.tree_view.copy()
        self.tree_view.setPlainText(_atr("Asm4_Export", "Copied to clipboard"))
    ...
    def drawUI(self):
        ...
        self.UI.setWindowTitle(
            _atr("Asm4_Export", 'Tree structure of the selected object'))
        ...
        copy_clip_but = QtGui.QPushButton(
            _atr("Asm4_Export", "Copy to clipboard"), button_box)
        button_box.addButton(copy_clip_but, QtGui.QDialogButtonBox.ActionRole)
        # button_box.addStretch()
        close_dlg_but = QtGui.QPushButton(
            _atr("Asm4_Export", "Close"), button_box)
