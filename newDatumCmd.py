...
class newDatum:
    ...
    def __init__(self, datumName):
        ...
        if self.datumName == 'Point':
            ...
            self.menutext = _atr("Asm4_createDatum", "New Point")
            self.tooltip = _atr("Asm4_createDatum",
                                "Create a new Datum Point in a Part")
            ...
            self.menutext = _atr("Asm4_createDatum", "New Axis")
            self.tooltip = _atr("Asm4_createDatum",
                                "Create a new Datum Axis in a Part")
            ...
            self.menutext = _atr("Asm4_createDatum", "New Plane")
            self.tooltip = _atr("Asm4_createDatum",
                                "Create a new Datum Plane in a Part")
            ...
            self.menutext = _atr("Asm4_createDatum", "New Coordinate System")
            self.tooltip = _atr("Asm4_createDatum",
                                "Create a new Coordinate System in a Part")
            ...
            self.menutext = _atr("Asm4_createDatum", "New Sketch")
            self.tooltip = _atr("Asm4_createDatum",
                                "Create a new Sketch in a Part")
    ...
    def Activated(self):
        ...
        # something went wrong
            ...
            Asm4.warningBox(_atr("Asm4_createDatum", "I can't create a ") +
                            self.datumType+_atr("Asm4_createDatum", " with the current selections"))
        ...
        if parentContainer:
            ...
            text, ok = QtGui.QInputDialog.getText(None, _atr("Asm4_createDatum", 'Create new ')+self.datumName,
                                                  _atr("Asm4_createDatum", 'Enter ')+self.datumName+_atr("Asm4_createDatum", ' name :')+' '*40, text=proposedName)
            if ok and text:
...
class newHole:
    def GetResources(self):
        return {"MenuText": _atr("Asm4_createDatum", "New Hole Axis"),
                "ToolTip": _atr("Asm4_createDatum", "Create a Datum Axis attached to a hole"),
...
Gui.addCommand('Asm4_createDatum', Asm4.dropDownCmd(
    createDatumList, _atr("Asm4_createDatum", 'Create Datum Object')))
