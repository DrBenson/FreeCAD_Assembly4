...
class placePartUI():
    ...
    def __init__(self):
        ...
        self.form.setWindowTitle(
            _atr("Asm4_placePart", 'Place a Part in the assembly'))
        ...
        try:
            ...
            Asm4.warningBox(
                _atr("Asm4_placePart", 'Please select ab object with a Placement property'))
    ...
    def onDatumClicked(self):
        ...
        if self.attLCSlist.selectedItems():
            ...
            FCC.PrintMessage(
                _atr("Asm4_placePart", "selection: ") + linkDot+a_LCS+'.' + "\n")
    ...
    def drawUI(self):
        ...
        self.formLayout.addRow(QtGui.QLabel(
            _atr("Asm4_placePart", 'Selected Object :')), self.selectedObject)
        ...
        self.mainLayout.addWidget(QtGui.QLabel(
            _atr("Asm4_placePart", "Select attachment LCS in parent Part :")))
