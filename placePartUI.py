...
class placePartUI():
    ...
    def __init__(self):
        ...
        self.form.setWindowTitle(App.Qt.translate(
            "Assembly", 'Place a Part in the assembly'))
        ...
        try:
            ...
            Asm4.warningBox(App.Qt.translate(
                "Assembly", 'Please select ab object with a Placement property'))
        ...
        (self.old_Parent, separator,
         self.old_parentLCS) = self.old_AttachedTo.partition('#')
        ...
        lcs_found = self.attLCSlist.findItems(
            old_parentLCS, QtCore.Qt.MatchExactly)
    ...
    def onDatumClicked(self):
        ...
        if self.attLCSlist.selectedItems():
            ...
            FCC.PrintMessage(App.Qt.translate(
                "Assembly", "selection: ") + linkDot+a_LCS+'.' + "\n")
    ...
    def drawUI(self):
        ...
        self.formLayout.addRow(QtGui.QLabel(App.Qt.translate(
            "Assembly", 'Selected Object :')), self.selectedObject)
        ...
        self.mainLayout.addWidget(QtGui.QLabel(App.Qt.translate(
            "Assembly", "Select attachment LCS in parent Part :")))
