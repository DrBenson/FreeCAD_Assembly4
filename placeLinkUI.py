...
class placeLinkUI():
    ...
    def __init__(self):
        ...
        if Asm4.isAsm4EE(self.selectedObj):
            ...
            FCC.PrintWarning(_atr(
                "Asm4_placePart", "WARNING : unsupported Assembly/Solver/Part combination, you shouldn't be seeing this\n"))
        ...
        self.form.setWindowTitle(_atr("Asm4_placePart", 'Place linked Part'))
        self.drawUI()
    ...
    def accept(self):
        if self.Apply():
            ...
            FCC.PrintWarning(_atr("Asm4_placePart", "Problem in selections\n"))
            return
    ...
    def clicked(self, button):
        if button == QtGui.QDialogButtonBox.Apply:
            ...
            if self.selectedObj.ExpressionEngine:
                ...
                confirmed = Asm4.confirmBox(_atr("Asm4_placePart", 'This command will release all attachments on ')+msgName+_atr(
                    "Asm4_placePart", ' and set it to manual positioning in its current location.'))
            ...
            if confirmed:
                ...
                # finish
                FCC.PrintMessage(
                    _atr("Asm4_placePart", "Part is now manually placed\n"))
                self.finish()
            else:
                FCC.PrintMessage(_atr("Asm4_placePart", "Part untouched\n"))
                self.finish()
    ...
    def initUI(self):
        ...
        self.parentList.addItem(_atr("Asm4_placePart", 'Please select'))
        self.parentTable.append(self.rootAssembly)
        parentIcon = self.rootAssembly.ViewObject.Icon
        self.parentList.addItem(parentIcon, _atr(
            "Asm4_placePart", 'Parent Assembly'), self.rootAssembly)
    ...
    def drawUI(self):
        ...
        self.leftLayout.addWidget(QtGui.QLabel(
            _atr("Asm4_placePart", "Linked Part :")))
        ...
        self.leftLayout.addWidget(QtGui.QLabel(
            _atr("Asm4_placePart", "Select LCS in Part :")))
        self.partLCSlist = QtGui.QListWidget(self.form)
        self.partLCSlist.setMinimumHeight(200)
        self.partLCSlist.setToolTip(
            _atr("Asm4_placePart", 'Select a coordinate system from the list'))
        ...
        self.rightLayout.addWidget(QtGui.QLabel(
            _atr("Asm4_placePart", "Parent Part :")))
        ...
        self.XtranslSpinBoxLabel = self.XoffsetLayout.addWidget(
            QtGui.QLabel(_atr("Asm4_placePart", "X Translation :")))
        ...
        self.XtranslSpinBox.setToolTip(
            _atr("Asm4_placePart", "Translation along X axis"))
        self.RotXButton = QtGui.QPushButton(
            _atr("Asm4_placePart", 'Rotate X +90°'))
        self.RotXButton.setToolTip(
            _atr("Asm4_placePart", "Rotate 90 deg around X axis"))
        ...
        self.YtranslSpinBoxLabel = self.YoffsetLayout.addWidget(
            QtGui.QLabel(_atr("Asm4_placePart", "Y Translation :")))
        ...
        self.YtranslSpinBox.setToolTip(
            _atr("Asm4_placePart", "Translation along Y"))
        self.RotYButton = QtGui.QPushButton(
            _atr("Asm4_placePart", 'Rotate Y +90°'))
        self.RotYButton.setToolTip(
            _atr("Asm4_placePart", "Rotate 90 deg around Y axis"))
        # add the QLDoubleSpinBox
        ...
        self.ZtranslSpinBoxLabel = self.ZoffsetLayout.addWidget(
            QtGui.QLabel(_atr("Asm4_placePart", "Z Translation :")))
        ...
        self.ZtranslSpinBox.setToolTip(
            _atr("Asm4_placePart", "Translation along Z:"))
        self.RotZButton = QtGui.QPushButton(
            _atr("Asm4_placePart", 'Rotate Z +90°'))
        self.RotZButton.setToolTip(
            _atr("Asm4_placePart", "Rotate 90 deg around Z axis"))
        # add to the layout
