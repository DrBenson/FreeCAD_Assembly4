...
infoToolTipUserAdded = {
    'FileName': _atr("Asm4_InfoPart", 'File Name')}
'''
    'DrawnBy': 'Drawn By',
...
def AssignCustomerValuesIntoUserFieldsForPartWithSingleBody(part, doc, singleBodyOfPart):
    ...
    if '/home/jonasthomas' in doc.FileName:
        ...
        raise NotImplementedError(
            _atr("Asm4_InfoPart", "Function not implemented yet"))
...
def jtCustomizations(part, doc, singleBodyOfPart):
    ...
    print(_atr("Asm4_InfoPart", "Base Part ID:"), base_part_id)
    print(_atr("Asm4_InfoPart", "Revision:"), revision)
    ...
    if part.Type == 'Assembly':
        ...
        if singleBodyOfPart is not None:
            ...
            part.PartDescription = _atr(
                "Asm4_InfoPart", "Multi Body Part(Not implemented)")
