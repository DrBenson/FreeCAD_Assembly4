...
infoToolTip = {
    'Document':     App.Qt.translate("Assembly", 'Document or File name'),
    'PartName':     App.Qt.translate("Assembly", 'Part Name'),
    'Reference':    App.Qt.translate("Assembly", 'Part Reference'),
    'PartLength':   App.Qt.translate("Assembly", 'Cut length of the raw material'),
    'PartWidth':    App.Qt.translate("Assembly", 'Width of the raw material'),
    'PartVolume':   App.Qt.translate("Assembly", 'Object dimensions (x, y, z)')}
...
infoToolTip_Invisible = {
    'FastenerDiameter': App.Qt.translate("Assembly", 'Fastener diameter'),
    'FastenerLenght':   App.Qt.translate("Assembly", 'Fastener length'),
    'FastenerType':     App.Qt.translate("Assembly", 'Fastener type')}
