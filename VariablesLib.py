...
class addVariable():
    ...
    def GetResources(self):
        ...
        tooltip = App.Qt.translate("Assembly", "<p>Adds a variable into the <i>Variables</i> placeholder in the document. "
        ...
        return {"MenuText": App.Qt.translate("Assembly", "Add Variable"),
                "ToolTip": tooltip,
                "Pixmap": iconFile}
    ...
    def drawUI(self):
        ...
        self.UI.setWindowTitle(App.Qt.translate("Assembly", 'Add Variable'))
        ...
        self.formLayout.addRow(QtGui.QLabel(
            App.Qt.translate("Assembly", 'Type')), self.typeList)
        # Variable Name
        self.varName = QtGui.QLineEdit()
        self.formLayout.addRow(QtGui.QLabel(
            App.Qt.translate("Assembly", 'Name')), self.varName)
        # Variable Value
        self.varValue = QtGui.QDoubleSpinBox()
        self.varValue.setRange(-1000000.0, 1000000.0)
        self.varValue.setDecimals(6)
        self.formLayout.addRow(QtGui.QLabel(
            App.Qt.translate("Assembly", 'Value')), self.varValue)
        # Documentation
        self.description = QtGui.QTextEdit()
        self.formLayout.addRow(QtGui.QLabel(
            App.Qt.translate("Assembly", 'Description')), self.description)
        # apply the layout
...
class delVariable():
    ...
    def GetResources(self):
        return {"MenuText": App.Qt.translate("Assembly", "Delete Variable"),
                "ToolTip": App.Qt.translate("Assembly", "Delete a Variable"),
    ...
    def Activated(self):
        ...
        # if it doesn't exist then create it (for older Asm4 documents)
        if not self.Variables:
            Asm4.messageBox(App.Qt.translate(
                "Assembly", 'There are no variables here'))
            return
        # (re-)initialise the UI
        self.UI.show()
        self.initUI()
    ...
    def initUI(self):
        ...
        self.description.clear()
        self.varList.clear()
        self.varList.addItem(App.Qt.translate("Assembly", 'Please choose'))
    ...
    def drawUI(self):
        ...
        # make this dialog stay above the others, always visible
        self.UI.setWindowFlags(QtCore.Qt.WindowStaysOnTopHint)
        self.UI.setWindowTitle(App.Qt.translate("Assembly", 'Delete Variable'))
        self.UI.setWindowIcon(QtGui.QIcon(
            os.path.join(Asm4.iconPath, 'FreeCad.svg')))
        self.UI.setMinimumWidth(470)
        self.UI.resize(470, 300)
...
tooltip = App.Qt.translate("Assembly", "Adds a variable into the \"Variables\" placeholder in the document.\n"
...
Gui.addCommand('Asm4_variablesCmd', Asm4.dropDownCmd(
    variablesCmdList, 'Variables', tooltip))
