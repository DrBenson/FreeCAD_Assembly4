...
class animationProvider:
    ...
    def nextFrame(self, resetAnimation) -> bool:
        raise NotImplementedError(App.Qt.translate("Asm4_Plot", "animationProvider.nextFrame not implemented."))
...
class animateVariable(animationProvider):
    ...
    class variableInvalidError(animationProvider.Error):
        ...
        def __init__(self, varName):
            ...
            detailMsg = App.Qt.translate("Asm4_Animate", 'The selected variable name "') + varName + App.Qt.translate("Asm4_Animate", '" is not valid. ') + \
                    App.Qt.translate("Asm4_Animate", 'Please select an existing variable.')
