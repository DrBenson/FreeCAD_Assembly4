...
class placePartUI():
    ...
    def __init__(self):
        ...
        parent_index = 1
        if old_Parent=='Parent Assembly' or old_Parent==App.Qt.translate("Asm4_placePart", 'Parent Assembly'):
            parent_found = True
        else:
            parent_found = False
    ...
    def onApply(self):
        ...
        if self.parentList.currentText()=='Parent Assembly' or self.parentList.currentText()==App.Qt.translate("Asm4_placePart", 'Parent Assembly'):
    ...
    def splitExpression(self, expr, parent ):
        ...
        if parent=='Parent Assembly' or parent==App.Qt.translate("Asm4_placePart", 'Parent Assembly'):
    ...
    def onDatumClicked( self ):
        ...
        if self.attLCSlist.selectedItems():
            ...
            if a_Part=='Parent Assembly' or a_Part==App.Qt.translate("Asm4_placePart", 'Parent Assembly'):
                linkDot = ''
            else:
                linkDot = a_Part+'.'
