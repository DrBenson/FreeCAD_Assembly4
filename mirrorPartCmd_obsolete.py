...
class mirrorPartCmd:
    ...
    def GetResources(self):
        tooltip = App.Qt.translate("Assembly", 'Create a mirrored part of a part. Use only on individual parts, not assemblies\n' +
                                   'You must re-create the attachment datums in the resulting part')
        iconFile = os.path.join(Asm4.iconPath, 'Asm4_Mirror.svg')
        return {"MenuText": App.Qt.translate("Assembly", 'Create symmetric of part'), "ToolTip": tooltip, "Pixmap": iconFile}
    ...
    def onOK(self):
        if self.mirroredPartName != '':
            ...
            lcs = symPart.newObject(
                'PartDesign::CoordinateSystem', 'LCS_'+symPart.Name)
            ...
            if self.symPlane.currentText() == 'X-Y':
                ...
                FCC.PrintMessage(App.Qt.translate(
                    "Assembly", "ERROR : You shouldn't see this message from mirrorPartCmd()\n"))
            # recompute
            symPart.recompute()
    ...
    def drawUI(self):
        ...
        self.mainLayout.addWidget(QtGui.QLabel(
            App.Qt.translate("Assembly", "Selected Part :")))
        ...
        # the symmetry plane
        self.mainLayout.addWidget(QtGui.QLabel(
            App.Qt.translate("Assembly", "Select the symmetry plane :")))
        ...
        self.mainLayout.addWidget(QtGui.QLabel(
            App.Qt.translate("Assembly", "Mirrored part's name :")))
