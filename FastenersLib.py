...
class insertFastener:
    ...
    def Activated(self):
        ...
        if fsType:
            ...
            if hasattr(newFastener,'length'):
                try:
                    ...
                    FCC.PrintMessage(translate("Fasteners", "Length \"") +selObj.length+ translate("Fasteners", "\" is not available, ignoring\n"))
        ...
        try:
            ...
            FCC.PrintMessage(translate("Fasteners", "unknown fastener type \"")+str(fsClass)+translate("Fasteners", "\", ignoring\n"))
