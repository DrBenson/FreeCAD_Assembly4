...
class makeShapeBinder():
    ...
    def GetResources(self):
        tooltip = App.Qt.translate("Assembly", "Create a reference to an external shape\n" +
        ...
        return {"MenuText": App.Qt.translate("Assembly", "Create a shape binder"), "ToolTip":  tooltip, "Pixmap": iconFile}
