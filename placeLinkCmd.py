...
class placeLinkCmd():
    ...
    def GetResources(self):
        return {"MenuText": App.Qt.translate("Assembly", "Edit Placement of a Part"),
                "ToolTip": App.Qt.translate("Assembly", "Move/Attach a Part in the assembly"),
        ...
        if selection is not None:
            ...
            if parent and parent == Asm4.getAssembly():
                ...
                if Asm4.isAsm4EE(selection):
                    ...
                    if hasattr(selection, 'MapMode'):
                        Asm4.warningBox(App.Qt.translate(
                            "Assembly", "This Part has the Attachment extension, it can only be placed manually"))
                    else:
                ...
                # else try to convert it
                    ...
                    convert = Asm4.confirmBox(App.Qt.translate(
                        "Assembly", "This Part wasn't assembled with this Assembly4 WorkBench, but I can convert it."))
                    if convert:
                ...
                Asm4.warningBox(App.Qt.translate(
                    "Assembly", 'Please select a link in the assembly Model.'))
        else:
                ...
                if hasattr(selection, 'Placement') and selection.getTypeIdOfProperty('Placement') == 'App::PropertyPlacement':
                    ...
                    if hasattr(selection, 'MapMode') and not Asm4.isAsm4EE(selection):
                        ...
                        # the selected object doesn't belong to the root assembly
                            ...
                            Asm4.warningBox(App.Qt.translate(
                                "Assembly", 'Please select an object in the assembly Model.'))
                            return
