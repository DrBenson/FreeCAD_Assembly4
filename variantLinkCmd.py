...
var = App.ActiveDocument.addObject(
    "Part::FeaturePython", 'varLink', VariantLink(),None,True)
...
class makeVariantLink():
    ...
    def GetResources(self):
        ...
        tooltip = App.Qt.translate("Assembly", "EXPERIMENTAL !!!\n"
                                   "Create a variant link to a part\n"
                                   "Select a part containing a \"Variables\" property container")
        iconFile = 'Variant_Link.svg'
        return {"MenuText": App.Qt.translate("Assembly", "Create a variant Part"),
                "ToolTip": tooltip,
    ...
    def Activated(self):
        ...
        if self.rootAssembly is None:
            Asm4.warningBox(
                App.Qt.translate("Assembly", 'Please create an Assembly'))
            return
    ...
    def onCreateLink(self):
        ...
        # only create link if there is a Part object and a name
            ...
            if App.ActiveDocument.FileName != '' or App.ActiveDocument == selectedPart.Document:
                ...
                Asm4.warningBox(
                    App.Qt.translate("Assembly", 'The current document must be saved before inserting an external part'))
                return
    ...
    def drawUI(self):
        ...
        self.UI.setWindowTitle(
            App.Qt.translate("Assembly", 'Insert a variant of a Part'))
